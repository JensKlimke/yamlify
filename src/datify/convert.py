...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description="Generate an HTML file from YAML files using a Jinja2 template.")
    parser.add_argument("input_dir", help="Path to the directory containing YAML files.")
    parser.add_argument("template_path", help="Path to the Jinja2 template file.")
    parser.add_argument("-r", '--recursive', action='store_true', default=False, help="Loads the files recursively from the folder and subfolders.")
    parser.add_argument("-p", '--processor', required=False, help="A python module with process(data) function to process the data before rendering.")
    parser.add_argument('--processor-path', required=False, help="The path of the processor module.")
    parser.add_argument("-o", "--output", required=False, default="output.html",
                        help="Path to save the rendered HTML file.")
    parser.add_argument("-f", "--output_filename_template", required=False, default=None,
                        help="Define a file template to generate multiple output files, one for each input file.")
    parser.add_argument("-l", "--list_structure", action='store_true', default=False, help="Lists the data structure.")
